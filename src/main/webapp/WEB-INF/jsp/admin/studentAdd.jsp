...
<div class="container" style="padding: 20px;">
    ...
    <div style="width: 500px; margin: auto;">
        <form  class="form-horizontal" action="${ctx}/addStudent" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="studentNum" id="studentNum" value="" placeholder="">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="realName" id="realName" value="" placeholder="">
                </div>
            </div>
            <div class="form-group">
